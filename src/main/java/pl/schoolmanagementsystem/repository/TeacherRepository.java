...
public interface TeacherRepository extends JpaRepository<Teacher, Long> {
    ...
    // todo Dlaczego nie wykorzystujesz czegoś takiego? Cżesto nie trzeba samemu wymyślać koła, wystarczy użyć tego co jest już stworzone
    //  List<Teacher> findById();
    //  https://www.baeldung.com/spring-data-derived-queries
    //  sprawdź sobie ;)
    //  Ten komentarz tyczy się wszystkich prostszych sql`ek w Twoim projekcie
